...
\begin{itemize}
    ...
    \item \lstinline|-spec variable_reach(uri(), {number(), number()} ) -> error |\lstinline{| ok.} \lstinline|}|
    \begin{itemize}
            \item \textbf{Bemenet}: Első paraméter az útvonal binárosan, a második párban rendre sor és oszlop információ, az adott változóról.
            \item \textbf{Kimenet}: \lstinline{error}, ammenyiben valami hiba történt, \lstinline{ok} ammenyiben mindben rendben.
...
\begin{itemize}
    ...
    \item \lstinline|-spec variable_origin(string(), {number(), number()})| \lstinline{ -> ok | error.}
    \begin{itemize}
...
Ez egy egyszerű fa elem, ami minimálisan a \lstinline{vscode.Command} \footnote{\url{https://code.visualstudio.com/api/references/vscode-api##Command}} osztályt bővíti ki. 
