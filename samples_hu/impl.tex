...
\lstset{caption=\lstinline{show.erl} teszt fájl diagnosztikai eredményei, label=src:erlang} \label{testShowSHELL}
...
\lstset{caption=Függvány függőség lekérdezésének eredménye, label=src:shell} \label{testDepFunSHELL2}
\begin{lstlisting}[language={shell}]  
